...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "YÖNETİCİ GİRİŞİ"))
...
class YoneticiGirisSayfa(QtWidgets.QMainWindow):
        ...
        def login(self):
            ...
            kullanici = boss.Yonetici.get_admin_from_db(email, sifre)
            if kullanici:
                self.yoneticiaGit()
            else:
